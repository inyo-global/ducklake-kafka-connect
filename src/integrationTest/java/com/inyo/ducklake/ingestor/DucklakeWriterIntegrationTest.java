...
class DucklakeWriterIntegrationTest {
  ...
  @SuppressWarnings(
      "java:S2077") // Suppress SQL injection warning - table names are test-controlled
  ...
  void integrationConflictRateComparison() throws Exception {
    ...
    for (var pct : percents) {
      ...
      try (var conn = factory.getConnection()) {
        ...
        String dropMergeSql =
            "DROP TABLE IF EXISTS lake.main." + SqlIdentifierUtil.quote(tableMerge);
        String dropInsertSql =
            "DROP TABLE IF EXISTS lake.main." + SqlIdentifierUtil.quote(tableInsert);
