...
class DucklakeTableManagerTimestampTest {
  ...
  class ArrowTypeMappingTests {
    ...
    void shouldMapTimestampTypes() {
      ...
      ArrowType.Timestamp secondTimestamp =
          new ArrowType.Timestamp(org.apache.arrow.vector.types.TimeUnit.SECOND, null);
      ArrowType.Timestamp milliTimestamp =
          new ArrowType.Timestamp(org.apache.arrow.vector.types.TimeUnit.MILLISECOND, null);
      ArrowType.Timestamp microTimestamp =
          new ArrowType.Timestamp(org.apache.arrow.vector.types.TimeUnit.MICROSECOND, null);
      ArrowType.Timestamp nanoTimestamp =
    ...
    void shouldMapDateTypes() {
      ArrowType.Date dayDate = new ArrowType.Date(org.apache.arrow.vector.types.DateUnit.DAY);
      ArrowType.Date milliDate =
          new ArrowType.Date(org.apache.arrow.vector.types.DateUnit.MILLISECOND);
    ...
    void shouldMapTimeTypes() {
      ArrowType.Time secondTime =
          new ArrowType.Time(org.apache.arrow.vector.types.TimeUnit.SECOND, 32);
      ArrowType.Time milliTime =
          new ArrowType.Time(org.apache.arrow.vector.types.TimeUnit.MILLISECOND, 32);
      ArrowType.Time microTime =
          new ArrowType.Time(org.apache.arrow.vector.types.TimeUnit.MICROSECOND, 64);
      ArrowType.Time nanoTime =
          new ArrowType.Time(org.apache.arrow.vector.types.TimeUnit.NANOSECOND, 64);
  ...
  class UnsupportedTypeTests {
    ...
    void shouldThrowForUnsupportedTypes() {
      ...
      assertThrows(
          IllegalArgumentException.class, () -> tableManager.toDuckDBType(unsupportedType));
    }
  }
